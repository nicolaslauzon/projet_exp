...
public:
    ImuOdomNode() : Node("imu_odom_node")
    {
        ...
        imuSubscription = this->create_subscription<sensor_msgs::msg::Imu>("vectornav/imu", messageQueueSize, std::bind(&ImuOdomNode::imuCallback, this,
                                                                                             std::placeholders::_1));
...
private:
    ...
    void imuCallback(const sensor_msgs::msg::Imu& msg)
    {
        try
        {
            ...
            {
                geometry_msgs::msg::TransformStamped robotToImuTf = tfBuffer->lookupTransform("imu", robotFrame, msg.header.stamp, std::chrono::milliseconds(100));
